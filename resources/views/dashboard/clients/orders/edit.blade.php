                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href=""
                                                                       ...
                                                                       class="btn {{ in_array($product->id, $order->products->pluck('id')->toArray()) ? 'btn-default disabled add-product-btn' : 'btn-success add-product-btn' }} btn-sm">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('dashboard.clients.orders.update', ['order' => $order->id, 'client' => $client->id]) }}" method="post">
                                ...
                                <button class="btn btn-primary btn-block" id="add-order-form-btn"><i class="fa fa-edit"></i> @lang('site.edit')</button>
